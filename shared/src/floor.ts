...
export const woventexFloor: Floor = {
  ...
  furniture: [
    ...
    { kind: "officeRug", x: 250, y: 130, rotation: deg(90) },
    ...
    // North-west corner, clear of the door lane on the west wall below it.
    { kind: "lamp", x: 2160, y: 62 },
    // On the desk, beside the monitor. 62 is the desk top.
    { kind: "gadget", x: 2298, y: 166, rotation: deg(-12), elevation: DESK_TOP },
    ...
    // Both tables in the south-east, running north-south and set close, so they
    // read as a pair rather than two things that happen to share a corner.
    { kind: "poolTable", x: 2440, y: 1420, solid: true },
    { kind: "gameTable", x: 2300, y: 1420, solid: true },
